...
class ResponseCode {
  ...
  static const int UNAUTHORISED = 401; // failure user isn't authorise
...
class ResponseMessage {
  ...
  static const String UNAUTHORISED =
      "User is unauthorised, try again later"; // failure user isn't authorise
  static const String NOT_FOUND =
      "URL isn't found, try again later"; // failure, API url isn't correct and not found
  static const String INTERNAL_SERVER_ERROR =
      "Something went wrong, try again later"; // failure, crash happened in server side

  // local status code
  static const String DEFAULT = "Something went wrong, try again later";
  static const String CONNECT_TIMEOUT = "Timeout error, try gain later";
